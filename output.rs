...
pub fn extract_pkh(inst: u32) -> arg_pkh {
    arg_pkh {
        rd : extract_simple(inst,19,4),
        imm : extract_simple(inst,14,5),
        rn : extract_simple(inst,23,4),
        tb : extract_simple(inst,13,1),
        rm : extract_simple(inst,9,4),
    }
}
...
pub fn extract_msr_reg(inst: u32) -> arg_msr_reg {
    arg_msr_reg {
        mask : extract_simple(inst,22,4),
        rn : extract_simple(inst,14,4),
        r : extract_simple(inst,27,1),
    }
}
...
pub fn extract_USADA8(inst: u32) -> arg_USADA8 {
    arg_USADA8 {
        ra : extract_simple(inst,19,4),
        rn : extract_simple(inst,11,4),
        rd : extract_simple(inst,23,4),
        rm : extract_simple(inst,15,4),
    }
}
...
pub fn extract_bfi(inst: u32) -> arg_bfi {
    arg_bfi {
        rd : extract_simple(inst,17,4),
        lsb : extract_simple(inst,12,5),
        msb : extract_simple(inst,21,5),
        rn : extract_simple(inst,8,4),
    }
}
...
pub fn extract_ldst_block(inst: u32) -> arg_ldst_block {
    arg_ldst_block {
        b : extract_simple(inst,26,1),
        w : extract_simple(inst,23,1),
        list : extract_simple(inst,2,16),
        u : extract_simple(inst,24,1),
        i : extract_simple(inst,25,1),
        rn : extract_simple(inst,18,4),
    }
}
